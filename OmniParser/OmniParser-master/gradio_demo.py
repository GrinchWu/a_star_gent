...
if os.environ.get("OMNIPARSER_HF_ENDPOINT") and not os.environ.get("HF_ENDPOINT"):
    os.environ["HF_ENDPOINT"] = os.environ["OMNIPARSER_HF_ENDPOINT"]

yolo_model = get_yolo_model(model_path='weights/icon_detect/model.pt')
caption_model_processor = get_caption_model_processor(
    model_name="florence2",
    model_name_or_path="weights/icon_caption_florence",
    processor_name_or_path=os.environ.get("OMNIPARSER_FLORENCE_PROCESSOR_PATH"),
)
